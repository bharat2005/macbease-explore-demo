...
const CrousalHeader = ({title, text, moreButton, moreText, onClick={}}) => {
  return (
           <View style={{flexDirection:'row', alignItems:'center', justifyContent:'space-between', paddingHorizontal:12}}>
               ...
               {
                moreButton && (
             <TouchableOpacity onPress={onClick} style={{gap:2,flexDirection:'row', justifyContent:'center', alignContent:'center' }}>
